...
- 생성일: 2026-04-25 / 최종 갱신: 2026-04-30
...
| S12 | 생성 중 대기 | DSP 후처리 대기 (30초 이내) + 홈 이동 | F4 | 3 |
...
| S12 | 생성 중 대기 | SCREEN | P0 | 달·별 부유 애니메이션 — v1.3.1 카피 "후처리 중" / 30초 이내 |
