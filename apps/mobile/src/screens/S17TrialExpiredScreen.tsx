 ...
 */
interface MoonCoverAnimationProps {
  styles: ReturnType<typeof makeStyles>;
}

function MoonCoverAnimation({ styles }: MoonCoverAnimationProps) {
...
export default function S17TrialExpiredScreen({ navigation }: TrialExpiredScreenProps) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container} testID="s17-container">
        {/* 달 → 구름 애니메이션 (2s ease-in) */}
        <MoonCoverAnimation styles={styles} />
