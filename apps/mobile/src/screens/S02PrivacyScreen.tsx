...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '600', color: '#82B090', marginBottom: 8 },
  ...
  bullet: { color: '#82B090', marginRight: 8, marginTop: 2 },
  rowContent: { flex: 1 },
  ...
  checkboxChecked: { backgroundColor: '#82B090', borderColor: '#82B090' },
