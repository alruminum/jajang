...
export default function CompletedTrackCard({ track, onDismiss }: Props) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    badgeText: { color: colors.accentSecondary, fontSize: 12, fontWeight: '500' },
    songName: { color: colors.textPrimary, fontSize: 18, fontWeight: '600', marginBottom: 6 },
    subtext: { color: colors.textSecondary, fontSize: 13, marginBottom: 20 },
    actions: { gap: 10 },
    primaryBtn: {
      height: 48,
      borderRadius: 24,
    ...
    primaryBtnText: { color: colors.bgPrimary, fontSize: 15, fontWeight: '600' },
