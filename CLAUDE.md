...
**Epic 19 — Local DSP Migration** · [stories](docs/epics/epic-19-local-dsp/stories.md)

| NN | impl 파일 |
|---|---|
| 01 spike-fork-eval | [docs/epics/epic-19-local-dsp/impl/01-spike-fork-eval.md](docs/epics/epic-19-local-dsp/impl/01-spike-fork-eval.md) |
| 02 spike-filter-probe | [docs/epics/epic-19-local-dsp/impl/02-spike-filter-probe.md](docs/epics/epic-19-local-dsp/impl/02-spike-filter-probe.md) |
| 03 spike-device-perf-size-license | [docs/epics/epic-19-local-dsp/impl/03-spike-device-perf-size-license.md](docs/epics/epic-19-local-dsp/impl/03-spike-device-perf-size-license.md) |
